      ...
      <div className="wraper">
        <div className="container">
          {this.state.tags.map((tag) => (
            <span className="containerTag" key={tag.id}>
              {tag.title}
              <span className="deleteButton">
                <button className="closebtn" onClick={() => this.handleDelete(tag.id)}>
                  X
                </button>
              </span>
            </span>
